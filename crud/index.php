    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th><a href="update_page.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Update</a></th>
                <th><a href="delete_page.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></th>
            </tr>
